...
PHP_MINIT_FUNCTION(sdl_mouse)
{
	...
	REGISTER_CURSOR_CLASS_CONST_LONG("DEFAULT", SDL_SYSTEM_CURSOR_DEFAULT);
	REGISTER_CURSOR_CLASS_CONST_LONG("TEXT", SDL_SYSTEM_CURSOR_TEXT);
	REGISTER_CURSOR_CLASS_CONST_LONG("CROSSHAIR", SDL_SYSTEM_CURSOR_CROSSHAIR);
	REGISTER_CURSOR_CLASS_CONST_LONG("CURSOR_PROGRESS", SDL_SYSTEM_CURSOR_PROGRESS);
	REGISTER_CURSOR_CLASS_CONST_LONG("NWSE_RESIZE", SDL_SYSTEM_CURSOR_NWSE_RESIZE);
	REGISTER_CURSOR_CLASS_CONST_LONG("NESW_RESIZE", SDL_SYSTEM_CURSOR_NESW_RESIZE);
	REGISTER_CURSOR_CLASS_CONST_LONG("EW_RESIZE", SDL_SYSTEM_CURSOR_EW_RESIZE);
	REGISTER_CURSOR_CLASS_CONST_LONG("NS_RESIZE", SDL_SYSTEM_CURSOR_NS_RESIZE);
	REGISTER_CURSOR_CLASS_CONST_LONG("MOVE", SDL_SYSTEM_CURSOR_MOVE);
