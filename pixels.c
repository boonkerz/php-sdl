...
/* {{{ proto bool SDL_GetMasksForPixelFormatEnum(int format, int &bpp, int &Rmask, int &Gmask, int &Bmask, int &Amask)
...
PHP_FUNCTION(SDL_GetMasksForPixelFormatEnum)
{
	...
	if (SDL_GetMasksForPixelFormatEnum((Uint32)format, &bpp, &rmask, &gmask, &bmask, &amask))
	{
		zval_dtor(z_bpp);
		ZVAL_LONG(z_bpp, bpp);
		zval_dtor(z_rmask);
...
/* {{{ proto bool SDL_GetPixelFormatEnumForMasks(int format, int bpp, int Rmask, int Gmask, int Bmask, int Amask)
...
PHP_FUNCTION(SDL_GetPixelFormatEnumForMasks)
{
	...
	RETURN_LONG(SDL_GetPixelFormatEnumForMasks((int)bpp, (Uint32)rmask, (Uint32)gmask, (Uint32)bmask, (Uint32)amask));
}
/* }}} */

/* {{{ proto SDL_PixelFormat SDL_CreatePixelFormat(int ncolors)
...
PHP_FUNCTION(SDL_CreatePixelFormat)
{
	...
	format = SDL_CreatePixelFormat((Uint32)index);
...
static PHP_METHOD(SDL_PixelFormat, __construct)
{
	...
	intern->format = SDL_CreatePixelFormat((Uint32)format);
	if (intern->format)
	{
		intern->flags = 0;
	}
...
/* {{{ proto void SDL_DestroyPixelFormat(SDL_PixelFormat format)
...
PHP_FUNCTION(SDL_DestroyPixelFormat)
{
	...
	SDL_DestroyPixelFormat(intern->format);
	intern->format = NULL;
}
/* }}} */

/* {{{ proto SDL_Palette SDL_CreatePalette(int ncolors)
...
PHP_FUNCTION(SDL_CreatePalette)
{
	...
	palette = SDL_CreatePalette((int)ncolors);
...
static PHP_METHOD(SDL_Palette, __construct)
{
	...
	intern->palette = SDL_CreatePalette(ncolors);
	if (intern->palette)
	{
		intern->flags = 0;
	}
...
/* {{{ proto void SDL_DestroyPalette(SDL_Palette palette)
...
PHP_FUNCTION(SDL_DestroyPalette)
{
	...
	SDL_DestroyPalette(intern->palette);
	intern->palette = NULL;
}
/* }}} */
...
zval *sdl_pixelformat_read_property(zend_object *object, zend_string *member, int type, void **cache_slot, zval *rv)
{
	...
	else if (!strcmp(member_val, "bits_per_pixel"))
	{
		ZVAL_LONG(retval, intern->format->bits_per_pixel);
	}
	else if (!strcmp(member_val, "bytes_per_pixel"))
	{
		ZVAL_LONG(retval, intern->format->bytes_per_pixel);
	}
...
static HashTable *sdl_pixelformat_get_properties(zend_object *object)
{
	...
	if (intern->format)
	{
		...
		SDL_PIXELFORMAT_ADD_PROPERTY("bits_per_pixel", intern->format->bits_per_pixel);
		SDL_PIXELFORMAT_ADD_PROPERTY("bytes_per_pixel", intern->format->bytes_per_pixel);
...
static const zend_function_entry php_sdl_palette_methods[] = {
	PHP_ME(SDL_Palette, __construct, arginfo_SDL_CreatePalette, ZEND_ACC_PUBLIC)
	...
	/* non-static methods */
	PHP_FALIAS(Free, SDL_DestroyPalette, arginfo_palette_none)
...
static const zend_function_entry php_sdl_pixelformat_methods[] = {
	PHP_ME(SDL_PixelFormat, __construct, arginfo_SDL_CreatePixelFormat, ZEND_ACC_PUBLIC)
	...
	/* non-static methods */
	PHP_FALIAS(Free, SDL_DestroyPixelFormat, arginfo_format_none)
...
PHP_MINIT_FUNCTION(sdl_pixels)
{
	...
	REGISTER_FORMAT_PROP("bits_per_pixel");
	REGISTER_FORMAT_PROP("bytes_per_pixel");
	...
	REGISTER_LONG_CONSTANT("SDL_PIXELFORMAT_XRGB4444", SDL_PIXELFORMAT_XRGB4444, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SDL_PIXELFORMAT_XRGB1555", SDL_PIXELFORMAT_XRGB1555, CONST_CS | CONST_PERSISTENT);
	REGISTER_LONG_CONSTANT("SDL_PIXELFORMAT_XBGR1555", SDL_PIXELFORMAT_XBGR1555, CONST_CS | CONST_PERSISTENT);
	...
	REGISTER_LONG_CONSTANT("SDL_PIXELFORMAT_XRGB8888", SDL_PIXELFORMAT_XRGB8888, CONST_CS | CONST_PERSISTENT);
