...
PHP_MINIT_FUNCTION(sdl_iostream)
{
        ...
        REGISTER_LONG_CONSTANT("SDL_IO_SEEK_SET",    SDL_RW_SEEK_SET, CONST_CS | CONST_PERSISTENT);
        REGISTER_LONG_CONSTANT("SDL_IO_SEEK_CUR",    SDL_RW_SEEK_CUR, CONST_CS | CONST_PERSISTENT);
        REGISTER_LONG_CONSTANT("SDL_IO_SEEK_END",    SDL_RW_SEEK_END, CONST_CS | CONST_PERSISTENT);
*/
        return SUCCESS;
        }
/* }}} */
