...
PHP_MINIT_FUNCTION(sdl_window)
{
	...
	REGISTER_WINDOW_CLASS_CONST_LONG("MOUSE_GRABBED", SDL_WINDOW_MOUSE_GRABBED);
	...
	REGISTER_WINDOW_CLASS_CONST_LONG("HIGH_PIXEL_DENSITY", SDL_WINDOW_HIGH_PIXEL_DENSITY);
