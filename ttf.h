...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_SDL_TTF_RenderGlyph_Blended, 0, 3, SDL_Surface, 0)
ZEND_ARG_OBJ_INFO(0, font, TTF_Font, 0)
ZEND_ARG_TYPE_INFO(0, ch, IS_LONG, 0)
ZEND_ARG_OBJ_INFO(0, color, SDL_Color, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_SDL_TTF_GetStringSize, 0, 4, 0, 0)
ZEND_ARG_OBJ_INFO(0, font, TTF_Font, 0)
ZEND_ARG_TYPE_INFO(0, text, IS_STRING, 0)
